...
//  EvFixedch=235,   -- can be reused --
    ...
    EvWBtempBias = 497,
    EvRawImageNum = 498,
    EvPixelShiftMotion = 499,
    EvPixelShiftMotionCorrection = 500,
    EvPixelShiftStddevFactorGreen = 501,
    EvPixelShiftEperIso = 502,
    EvPixelShiftNreadIso = 503,
    EvPixelShiftPrnu = 504,
    EvPixelshiftShowMotion = 505,
    EvPixelshiftShowMotionMaskOnly = 506,
    EvPixelShiftAutomatic = 507,
    EvPixelShiftNonGreenHorizontal = 508,
    EvPixelShiftNonGreenVertical = 509,
    EvPixelShiftNonGreenCross = 510,
    EvPixelShiftStddevFactorRed = 511,
    EvPixelShiftStddevFactorBlue = 512,
    EvPixelShiftGreenAmaze = 513,
    EvPixelShiftNonGreenAmaze = 514,
    EvPixelShiftGreen = 515,
    EvPixelShiftRedBlueWeight = 516,
    EvPixelShiftBlur = 517,
    EvPixelShiftSigma = 518,
    EvPixelShiftSum = 519,
    EvPixelShiftExp0 = 520,
    EvPixelShiftHoleFill = 521,
    EvPixelShiftMedian = 522,
    EvPixelShiftMedian3 = 523,
    EvPixelShiftMotionMethod = 524,
    EvPixelShiftSmooth = 525,
    EvPixelShiftLmmse = 526,
    EvPixelShiftEqualBright = 527,
    EvPixelShiftEqualBrightChannel = 528,
    EvChrrt = 529,
