...
//    EvWavenaedge3 = 473,
    ...
    EvWBtempBias = 495,
    EvRawImageNum = 496,
    EvPixelShiftMotion = 497,
    EvPixelShiftMotionCorrection = 498,
    EvPixelShiftStddevFactorGreen = 499,
    EvPixelShiftEperIso = 500,
    EvPixelShiftNreadIso = 501,
    EvPixelShiftPrnu = 502,
    EvPixelshiftShowMotion = 503,
    EvPixelshiftShowMotionMaskOnly = 504,
    EvPixelShiftAutomatic = 505,
    EvPixelShiftNonGreenHorizontal = 506,
    EvPixelShiftNonGreenVertical = 507,
    EvPixelShiftNonGreenCross = 508,
    EvPixelShiftStddevFactorRed = 509,
    EvPixelShiftStddevFactorBlue = 510,
    EvPixelShiftGreenAmaze = 511,
    EvPixelShiftNonGreenAmaze = 512,
    EvPixelShiftGreen = 513,
    EvPixelShiftRedBlueWeight = 514,
    EvPixelShiftBlur = 515,
    EvPixelShiftSigma = 516,
    EvPixelShiftSum = 517,
    EvPixelShiftExp0 = 518,
    EvPixelShiftHoleFill = 519,
    EvPixelShiftMedian = 520,
    EvPixelShiftMedian3 = 521,
    EvPixelShiftMotionMethod = 522,
    EvPixelShiftSmooth = 523,
    EvPixelShiftLmmse = 524,
