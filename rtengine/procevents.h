...
//    EvLbaselog = 424,   -- can be reused --
    ...
    EvWavvart = 499,
    EvWavlimd = 500,
    EvWavretinexMethod = 501,
    EvWavCTCurve = 502,
    EvWavchrrt = 503,
    EvWavretinexMethodpro = 504,
    EvWavenamerge = 505,
    EvWaveinput = 506,
    EvWavmergevMethod = 507,
    EvWavmergMethod = 508,
    EvWavbalanlow = 509,
    EvWavbalanhigh = 510,
    EvWavblen = 511,
    ...
    EvWavushamet = 514,
    EvWavenareti = 515,
    EvWavmergBMethod = 516,
    EvWavradius = 517,
    EvWavhighlights = 518,
    EWavh_tonalwidth = 519,
    EvWavshadows = 520,
    EvWavs_tonalwidth = 521,
    EvWavscale = 522,
//    EvWavenaTCresi = 475,
//    EvWavenaedge3 = 476,
    EvWavgrad = 523,
    EvWavmergCurve = 524,
    EvWavCTgainCurve = 525,
    EvcbdlMethod = 526,
    EvWavsizelab = 527,
    EvWaveletbalmer = 528,
    EvWavbalmerch = 529,
    ...
    EvWavshstyCurve = 537,
    EvWavmerg2Curve = 538,
    EvWaveletbalmer2 = 539,
    EvWavbalmerres2 = 540,
    EvWavmergMethod2 = 541,
    EvWavshapMethod = 542,
    EvWavshapind = 543,
    EvWavsty2Curve = 544,
    EvWavusharpmet = 545,
