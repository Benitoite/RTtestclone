...
//    EvLbaselog = 424,   -- can be reused --
    ...
    EvCATybscen = 482,
    EvCATAutoyb = 483,
    EvLocrgbenaexpose = 484,
    EvlocalwbEnabled = 485,
    EvlocalwblocY = 486,
    EvlocalwblocX = 487,
    EvlocalwbCenter = 488,
    EvlocalwbDegree = 489,
    Evlocalwbtransit = 490,
    EvlocalwblocYT = 491,
    EvlocalwblocXL = 492,
    EvlocalwbSmet = 493,
    Evlocalwbsensi = 494,
    Evlocalwbnbspot = 495,
    Evlocalwbanbspot = 496,
    Evlocalwbhueref = 497,
    Evlocalwbchromaref = 498,
    Evlocalwblumaref = 499,
    Evlocalwbthres = 500,
    Evlocalwbproxi = 501,
    Evlocalwbcircrad = 502,
    EvlocalwbqualityMethod = 503,
    Evlocalwbretrab = 504,
    EvLocrgbenawb = 505,
    Evlocalwbtemp = 506,
    Evlocalwbgreen = 507,
    Evlocalwbequal = 508,
    EvlocalwbwbMethod = 509,
    Evlocalwbgamma = 510,
    EvlocalwbwbcamMethod = 511,
