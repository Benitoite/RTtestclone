...
//    EvLbaselog = 424,   -- can be reused --
    ...
    EvLocrgbenaexpose = 475,
    EvlocalwbEnabled = 476,
    EvlocalwblocY = 477,
    EvlocalwblocX = 478,
    EvlocalwbCenter = 479,
    EvlocalwbDegree = 480,
    Evlocalwbtransit = 481,
    EvlocalwblocYT = 482,
    EvlocalwblocXL = 483,
    EvlocalwbSmet = 484,
    Evlocalwbsensi = 485,
    Evlocalwbnbspot = 486,
    Evlocalwbanbspot = 487,
    Evlocalwbhueref = 488,
    Evlocalwbchromaref = 489,
    Evlocalwblumaref = 490,
    Evlocalwbthres = 491,
    Evlocalwbproxi = 492,
    Evlocalwbcircrad = 493,
    EvlocalwbqualityMethod = 494,
    Evlocalwbretrab = 495,
    EvLocrgbenawb = 496,
    Evlocalwbtemp = 497,
    Evlocalwbgreen = 498,
    Evlocalwbequal = 499,
    EvlocalwbwbMethod = 500,
    Evlocalwbgamma = 501,
    EvlocalwbwbcamMethod = 502,
