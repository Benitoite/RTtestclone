...
public:
    ...
    /**
      ...
      */
    void setDefaults(int subPart = SP_FLAGS|SP_EXIF|SP_IPTC|SP_TOOL);
    /**
...
public:
    ...
    void set(bool v, int subPart = ProcParams::SP_FLAGS|ProcParams::SP_EXIF|ProcParams::SP_IPTC|ProcParams::SP_TOOL);
