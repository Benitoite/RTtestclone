...
//                                    float nbrwt[TS * TS] ALIGNED64;
                                ...
                                array2D<float> mask;
                                float detail_thr = dnparams.Ldetailthr;

                                if (detail_thr > 0) {
                                    float scalea = 1.f;
                                    mask(width, height);
                                    float thr = log2lin(float(detail_thr) / 200.f, 100.f);
                                    ...
                                    buildGradientsMask(width, height, labdn->L, m2, params_Ldetail / 100.f, 7, 3, alfa, beta, 1);
