    ...
    */
    ...
    if (!selected.empty()) {
        ...
        if (selected.size() == 1) {
            ...
            whitebalance->setAdjusterBehavior (false, false, false, false, false);
            ...
            whitebalance->setAdjusterBehavior (options.baBehav[ADDSET_WB_TEMPERATURE], options.baBehav[ADDSET_WB_GREEN], options.baBehav[ADDSET_WB_CAT02],options.baBehav[ADDSET_WB_EQUAL], options.baBehav[ADDSET_WB_TEMPBIAS]);
