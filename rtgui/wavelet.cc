...
// Toning
    ...
    opacityShapeBY = static_cast<FlatCurveEditor*>(opaCurveEditorG->addCurve(CT_Flat, "", nullptr, false, false));
...
//Retinex in Wavelet
    ...
    cTshape->setResetCurve(FlatCurveType(default_params.ccwTcurve.at(0)), default_params.ccwTcurve);
    ...
    cTgainshape->setResetCurve(FlatCurveType(default_params.ccwTgaincurve.at(0)), default_params.ccwTgaincurve);
...
// Merge files
    ...
    cmergshape->setResetCurve(FlatCurveType(default_params.ccwmergcurve.at(0)), default_params.ccwmergcurve);
    ...
    cmerg2shape->setResetCurve(FlatCurveType(default_params.ccwmerg2curve.at(0)), default_params.ccwmerg2curve);
    ...
    cstyshape->setResetCurve(FlatCurveType(default_params.ccwstycurve.at(0)), default_params.ccwstycurve);
    ...
    cstyshape2->setResetCurve(FlatCurveType(default_params.ccwsty2curve.at(0)), default_params.ccwsty2curve);
...
{
    idle_register.add(
    [this, cdmin, cdma, mini, maxi, Tmean, Tsigma, Tmin, Tmax]() -> bool {
        float nm, nM, nZ, nA, nB, nS, nX, nY;
        nX = cdmin;
        nY = cdma;
        nm = mini;
        nM = maxi;
